...
public class TrainMethodsReturn {
  ...
  public static int returnNewInt(int intValue) {
    return 3 * intValue;
  }

  public static long returnNewLong(long longValue) {
    return longValue - 4;
  }

  public static String returnNewChar(char charValue) {
    return Character.toString(charValue) + charValue;
  }

  public static Float returnNewFloat(float floatValue) {
    return floatValue / 2;
  }

  public static Double returnNewDouble(double doubleValue) {
    return doubleValue + 8;
  }

  public static Short returnNewShort(short shortValue) {
    return (short) (shortValue - 1);
  }

  public static Byte returnNewByte(byte byteValue) {
    return (byte) (byteValue * 2);
  }

  public static Boolean returnNewBoolean(boolean booleanValue) {
    return booleanValue;
  }
}
